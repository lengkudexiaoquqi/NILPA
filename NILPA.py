...
# Obtain similarity matrix
    ...
    # Update node community labels by NILPA
    ...
    # The community detection process of NILPA
    ...
    # Find small-scale community nodes
    ...
    # Handle small-scale community nodes
    ...
    # Find the optimal community index of nodes
    def find_node_community_index(self, node, community_list):
        ...
        for community in community_list:
            if node in community:
                return index
            index = index + 1
    # Find the optimal community of nodes
...
def objective(trial):
    ...
    nilpa = NILPA(graph, content_matrix, alpha,  n)
    predicted_label_dict = nilpa.community_detection()
    nmi = evaluate_nmi(predicted_label_dict, node_community_label_list)
    return nmi

# Main method of NILPA
...
#
# Main method of parameter automatic optimization
